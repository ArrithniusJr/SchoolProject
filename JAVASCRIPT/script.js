window.onload = ()=>{
    ...
    var skds = 0;
    var smen = 0;
        var ditems = document.querySelectorAll(".dstnitem");
    ...
    destination.addEventListener("click",function(){
        ...
        if(ddown == false){
           ...
           ditems[i].addEventListener("click",function(){
             ...
             dstn.innerHTML = this.innerHTML ;
             document.querySelector(".fa-arrow-down").style.color = "#fff";
           });
        }
    ...
    pdprev.addEventListener("click",function(){
     ...
     for(var i = 0; i < msgs.length; i++){
         msgs[i].addEventListener("click",function(){
             alert("Apologies! Services Unavailable.");
         });
     }
...
$(function(){
  $("#tsearch").on("click", function(){
    alert("Tour Request Received, wait for our call");
  });
});
